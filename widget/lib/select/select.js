...
(function() {
	...
	MobileSelect.prototype = {
		...
		init: function(config){
			...
			//按钮监听
			_this.cancelBtn.addEventListener('touchstart',function(){
				_this.hide();
		    });

		    _this.ensureBtn.addEventListener('touchstart',function(){
				_this.hide();
			    if(!_this.liHeight) {
			        _this.liHeight =  _this.mobileSelect.querySelector('li').offsetHeight;
			    }
		    ...
		    _this.trigger.addEventListener('touchstart',function(){
		    	_this.show();
		    });
		    _this.grayLayer.addEventListener('touchstart',function(){
				_this.hide();
		    });
		    _this.popUp.addEventListener('touchstart',function(){
